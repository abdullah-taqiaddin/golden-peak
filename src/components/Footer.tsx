...
export function Footer() {
  return (
    <footer dir="rtl" className="border-t border-brand-silver/20 bg-brand-navy/95 py-12">
      <div className="mx-auto flex w-full max-w-[1280px] flex-col items-center justify-between gap-8 px-8 md:flex-row">
